...
lable_0 = Label(root,text="Weather Check",width = 20,bg='white',font=("bold",20),fg='brown')
...
lable_2 = Label(root,text="Temperature : ",width = 20,bg='white',font=("bold",10),fg='blue')
...
lable_unit = Label(root,text="Temperature in Kelvin And Pressure in mb",width = 35,bg='white',font=("bold",10),fg='brown')
